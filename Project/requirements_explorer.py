...
st.set_page_config(
    page_title="Requirements Explorer",
    page_icon="📄",
    layout="wide",
...
if st.sidebar.button("📄 Backlog Requirements Explorer", use_container_width=True, type="primary"):
...
try:
    ...
    if df.empty:
        st.info("ℹ️ No requirements logged in the database yet. Use the main workspace form to add one.")
    else:
